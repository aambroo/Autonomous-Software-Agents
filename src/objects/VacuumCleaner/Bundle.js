...
class VcFrontend { 
    constructor() { 
        ...
        this.vcb = new VcBackend(); this.agent; this.table; 
        this.mInput.value = 10; this.nInput.value = 10; 
        this.delay.value = 300; this.nextInterval; 
    ...
    initiateListeners() { 
        this.startBtn.onclick = () => { 
            ...
            this.vcb.reset(); this.createTable(); 
...
createTable() { 
    ...
    for (let i = 0; i < this.vcb.m; i++) { 
        ...
        for (let j = 0; j < this.vcb.n; j++) { 
            ...
            td.id = `row-${i}-col-${j}`; number.className = 'cell-number'; 
